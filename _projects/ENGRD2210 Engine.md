---
layout: project
title: Rehlko CH440 Analysis
description: Class Assignment
image: /assets/images/kohler-engine.jpg
---

## **Collaborators:** ##
_[Susanna Aufrichtig](mailto:sma283@cornell.edu), [Elias Herrera Hernandez](mailto:eh697@cornell.edu), [Camille Eckert](mailto:cse49@cornell.edu)_
...
First let’s find the work output and heat input of a 14 HP cycle. Per the CH440 datasheet, the maximum torque output of 22.7 ft-lb is at 2800 rpm. 
...
{% raw%}
$$
W_\text{cyc} = \frac{P}{\text{cycles/sec}} = \frac{\tau \frac{2 \pi \cdot RPM}{\text{60 sec}}}{\frac{RPM}{\text{2 cycles ⋅ 60 sec}}} = 4 \pi \tau = 4 \pi \cdot \text{30.78 Nm} = \text{386.79 J}
$$
{% endraw %}

With the previously calculated efficiency and this newly calculated work per cycle, we can find the heat input:
...
I determined these values as part of my work for Cornell Baja Racing last year. I created a dynamometer setup which measured the power band RPM and maximum torque using a hall effect sensor, load cell, and water break.
